...
export default function InquiryModal({ source = 'unknown' }) {
  ...
  useEffect(() => {
    const handleKey = (e) => { if (e.key === 'Escape' && open) reset(); };
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={submit} noValidate>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '28px' }}>
              <div>
                <div id="inquiry-modal-title" style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '22px', fontWeight: 500, color: '#1C1B1F', marginBottom: '4px' }}>
                  Let&apos;s talk.
                </div>
